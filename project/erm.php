...
<a href="indexemploy.php">Go back</a>
    <table border='1'>
        ...
        <?php } ?>
            ...
            Email:<input type="email" name="addemail" required><br><br>
            OfficeCode:<input type="number" max="7" min="1" name="addoffice"><br><br>
            ...
            ID:<input type="text" name="demotebyid" required><br><br>
            Report To:<input type="text" name="setreport" required><input type="submit" value="Demoted"><br><br>
