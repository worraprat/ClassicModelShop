...
<body>
        ...
        Enter Product Code: 
            ...
            <?php echo $row['productCode'] ?><br><br>
        Enter Product Name: 
        ...
        Enter Quantity In Stock : 
            <input type = "number" name = 'quantityInStock' min="0" value = '<?php echo $row['quantityInStock'] ?>' step=1 required > <br><br>
        Enter Buy Price: 
            <input type = "number" name = 'buyPrice' min="0" value = '<?php echo $row['buyPrice'] ?>' step=any required > <br><br>
        Enter MSRP: 
            <input type = "number" name = 'MSRP' min="0" value = '<?php echo $row['MSRP'] ?>' step=any required > <br><br><br>

        <input type="submit" value="Edit"><br><br>
    </form>
    
    <a href="./productAdmin.php">Back</a><br>
