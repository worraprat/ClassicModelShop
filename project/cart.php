...
<ul>
  ...
  <?php if ($username=='Guest') {
    echo '<li><a class="c" href="login.php">login</a></li>';
    echo '<li><a class="b" href="register.php">register</a></li>';
  }else{
    echo '<li><a class="c" href="login.php">logout</a></li>';
    echo '<li><a class="b" href="profile.php">' ?> <?php echo $username."</a></li>";
  }
  ?>
...
?>
    ...
    <form method="post" action="cart.php?action=add&id=<?php echo $row['productCode'];?>">
        ...
        <h4 class="text-info"style="margin-left:10px;margin-top:-2px;font-size:15px;">ProductVender : <?php echo $row['productVendor'];?></h4>
          ...
          <input type="number" min="1" max="100" name="quantity" class="form-control"style="margin-top:15px;" value="1"/>
