<?php require'./connect.php';
    ...
    // echo $result2;
     ...
     $credit=$_POST['climit'];
        ...
        $addr2=!empty($addr2) ? '$addr2' : "NULL";
        $state=!empty($state) ? '$state' : "NULL";
        $postal=!empty($state) ? '$postal' : "NULL";

     $sql="insert into users(username,password,Name,contactFirstname,contactLastname,phone,addressLine1,addressLine2
     ,city,state,postalcode,country,customerNumber,creditlimit,point)
